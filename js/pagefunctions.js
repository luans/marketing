(function() {
    ...
    $("#submitWpp").click(function(e) {
        
        // um número no formato internacional (ativo no WhatsApp)
        let number = '5519983888695'
        
        // o texto ou algo vindo de um <textarea> ou <input> por exemplo
        let msg = 'Olá, gostaria de receber mais informações sobre a oportunidade.'
        ...
        if (!isMobile) {
            ...
            target = `whatsapp://send?text=${encodeURIComponent(msg)}`
        }
